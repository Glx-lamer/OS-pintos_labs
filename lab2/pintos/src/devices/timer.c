...
//! Start of lab1 part (Modified timer)
...
/* Array and size */
struct sleeped_thread* sleeped_array = NULL;
int64_t array_size = 0;

/* Add to array of sleeping threads */ 
void
...
/* Delete from array of sleeping threads */
void
pop_thread ()
{
...
//! End of lab1 part (Modified timer)
...
timer_interrupt (struct intr_frame *args UNUSED)
{
  ...
  //! Start of lab1 part (Unsleep threads)

  unsleep_thread();

  //! End of lab1 part (Unsleep threads)
